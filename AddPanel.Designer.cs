namespace ShomreiTorah.Rafflizer {
	partial class AddPanel {
		...
		private void InitializeComponent() {
			...
			this.personSelector.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.Controls_KeyPress);
			// 
			// ticketId
			// 
			...
			this.ticketId.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.Controls_KeyPress);
			// 
			// isPaid
			// 
